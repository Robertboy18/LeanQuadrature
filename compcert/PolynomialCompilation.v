...
From compcert Require Import Errors Integers Values Events Globalenvs Smallstep Behaviors
  ...
  Compiler Asm.
From QuadratureC Require Import ClightExample PolynomialApplication AnnotatedBehavior
  CminorApplication CompilerBackend ApplicationAccuracy.

Import ListNotations.
Module App := PolynomialApplication.
...
Proof.
  intro H. rewrite (App.application_all_behaviors beh H).
...
Print Assumptions assembly_terminates.
Print Assumptions assembly_all_behaviors.
