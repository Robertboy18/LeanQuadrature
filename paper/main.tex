...
We moved the general theory and the additional rules and certificates
developed here into LeanPDE for reuse. They build on mathlib and LeanPDE's
existing quadrature interfaces, midpoint rule, and two-point rule.
...
predates our general Hermite remainder and is not used by that proof.
...
weighted construction, remainder, convergence, and Legendre certificate
proofs, now shared through LeanPDE. The accuracy certificates for the ten
stored rules and the program proofs remain in LeanQuadrature.
...
The general Gaussian and Legendre proofs developed in LeanQuadrature now
live in LeanPDE; this project imports them.
